    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-sm border-b border-border">
      <div className="container mx-auto px-4 h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4">
          <a href="tel:+15550123456" className="flex items-center gap-2 text-sm font-semibold hover:text-primary transition-colors">
        ...
        <div className="md:hidden absolute top-20 left-0 right-0 bg-white border-b border-border shadow-lg animate-in slide-in-from-top-2 p-4">
          ...
          <div className="flex flex-col gap-3">
            <a 
              ...
              className="flex items-center justify-center gap-2 w-full py-4 bg-muted text-foreground font-semibold rounded-sm"
            >
              <Phone className="w-5 h-5" />
              Tap to Call: (555) 012-3456
            </a>
